...
function checkAnswerInputHandler(_, element, feedback_element) {
  if (
    ...
    feedback_element.src =
      'https://cdn.bfldr.com/Z0BJ31FP/at/b3t37v9cm7kbhrbhp7gv3jq8/icon-thumbs-up.svg';
  } else {
    element.dataset.correct = 'false';
    feedback_element.src =
      'https://cdn.bfldr.com/Z0BJ31FP/at/bw386wvpmfxrvpgb6sr9mmp/icon-thumb-down.svg';
  }
}
...
function create_verses(container_id, song, generate_input) {
  ...
  for (let i = 0; i < song.number_of_verses; i++) {
    ...
    button_translation.setAttribute(
      'src',
      'https://cdn.bfldr.com/Z0BJ31FP/at/m669ktgkt87xkr7nx3fknfb3/icon-translation-1.svg'
    );
